...
class Traffic(object):
    ...
    def load_traffic(self, config):
        ...
        self.tm_cnt = tms_shape[0]  # total flow nums inclued in traffic_matrices
...
class Environment(object):
    def __init__(self, config, is_training=False):
        ...
        self.tm_cnt = self.traffic.tm_cnt  # total flow nums inclued in traffic_matrices
        self.traffic_file = self.traffic.traffic_file  # traffic_file path
        ...
        # print(self.shortest_paths_link)
